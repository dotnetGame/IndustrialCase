 ...
 *			boolean hasActive, Set{@literal <}Direction{@literal >} possibleFacings, boolean canBeWrenched,
 ...
 *
 *	{@literal @}Override
 *	public Set{@literal <}Direction{@literal >} getSupportedFacings() {
 ...
 *	private final Set{@literal <}Direction{@literal >} possibleFacings;
 ...
 *		<li><b>supportedFacings</b>: A set of <code>Direction</code>s that the block can face, used for rotating by the wrench for example.
